...
import com.brianbett.twitter.databinding.SingleProfileUserTweetBinding;
...
public class ProfileTweetsRecyclerViewAdapter extends RecyclerView.Adapter<ProfileTweetsRecyclerViewAdapter.MyViewHolder> {

    private final ArrayList<Tweet> tweets;
    private final Context context;
    private final String userId;

    public ProfileTweetsRecyclerViewAdapter(Context context, ArrayList<Tweet> tweets,String userId) {
        this.tweets = tweets;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        SingleProfileUserTweetBinding binding=SingleProfileUserTweetBinding.inflate(LayoutInflater.from(parent.getContext()),parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(tweets.get(position).getRetweets().contains(userId)){
            holder.retweeted.setVisibility(View.VISIBLE);
            holder.retweeted.setText(tweets.get(position).getUserDetails().getUsername()+" retweeted");
        }else{
...
//        retweeting/undoing retweet
    ...
    protected static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull SingleProfileUserTweetBinding binding) {
