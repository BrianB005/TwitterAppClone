...
public class MyProfileLikesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        MyProfileLikedTweetsRecyclerViewAdapter recyclerViewAdapter=new MyProfileLikedTweetsRecyclerViewAdapter(getActivity().getApplicationContext(),tweetsArrayList);


        RetrofitHandler.getMyProfileLikedTweets(getContext(), new TweetsAndCommentsInterface() {
