...
public class ProfileMediaRecyclerViewAdapter extends RecyclerView.Adapter<ProfileMediaRecyclerViewAdapter.MyViewHolder> {
    private final ArrayList<ProfileTweetOrComment> tweets;
    private final Context context;


    public ProfileMediaRecyclerViewAdapter(Context context, ArrayList<ProfileTweetOrComment> tweets) {
        this.tweets = tweets;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        StorageReference storageReference1= FirebaseStorage.getInstance().getReference("images/"+tweets.get(position).getUserDetails().getProfilePic());
        ...
        holder.timePosted.setText(tweets.get(position).getTimePosted());
...
//        retweeting/undoing retweet
    ...
    protected static class MyViewHolder extends RecyclerView.ViewHolder{
        TextView timePosted,username,name,tweetTitle,commentsCount,likesCount,retweetsCount,replyUsername;
        View replyingTo;
