...
public class ProfileLikedTweetsRecyclerViewAdapter extends RecyclerView.Adapter<ProfileLikedTweetsRecyclerViewAdapter.MyViewHolder> {

    private final ArrayList<ProfileTweetOrComment> tweets;
    private final Context context;


    public ProfileLikedTweetsRecyclerViewAdapter(Context context, ArrayList<ProfileTweetOrComment> tweets) {
        this.tweets = tweets;
