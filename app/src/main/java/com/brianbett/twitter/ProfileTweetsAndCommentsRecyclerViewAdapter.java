...
public class ProfileTweetsAndCommentsRecyclerViewAdapter extends RecyclerView.Adapter<ProfileTweetsAndCommentsRecyclerViewAdapter.MyViewHolder> {

    private final ArrayList<ProfileTweetOrComment> tweets;
    private final Context context;

    public ProfileTweetsAndCommentsRecyclerViewAdapter(ArrayList<ProfileTweetOrComment> tweets, Context context) {
        this.tweets = tweets;
