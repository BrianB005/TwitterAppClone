...
public class MyProfileMediaRecyclerViewAdapter extends RecyclerView.Adapter<MyProfileMediaRecyclerViewAdapter.MyViewHolder> {
    private final ArrayList<ProfileTweetOrComment> tweets;
    private final Context context;


    public MyProfileMediaRecyclerViewAdapter(Context context, ArrayList<ProfileTweetOrComment> tweets) {
        this.tweets = tweets;
