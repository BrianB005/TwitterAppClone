...
public class MyProfileTweetsRecyclerViewAdapter extends RecyclerView.Adapter<MyProfileTweetsRecyclerViewAdapter.MyViewHolder> {

    private final ArrayList<Tweet> tweets;
    private final Context context;

    public MyProfileTweetsRecyclerViewAdapter(Context context, ArrayList<Tweet> tweets) {
        this.tweets = tweets;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        SingleTweetBinding binding=SingleTweetBinding.inflate(LayoutInflater.from(parent.getContext()),parent,false);
