...
public class MyProfileTweetsAndCommentsRecyclerViewAdapter extends RecyclerView.Adapter<MyProfileTweetsAndCommentsRecyclerViewAdapter.MyViewHolder> {

    private final ArrayList<ProfileTweetOrComment> tweets;
    private final Context context;

    public MyProfileTweetsAndCommentsRecyclerViewAdapter(ArrayList<ProfileTweetOrComment> tweets, Context context) {
        this.tweets = tweets;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        SingleMyProfileTweetOrCommentBinding binding=SingleMyProfileTweetOrCommentBinding.inflate(LayoutInflater.from(parent.getContext()),parent,false);
